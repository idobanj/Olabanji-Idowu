...
export function Hero() {
  ...
  return (
    <section id="home-section" className="relative flex min-h-[85vh] items-center justify-center py-20 transition-colors duration-200">
        ...
        <div className="flex flex-col items-center justify-center text-center md:flex-row md:text-left md:justify-between gap-12">
          ...
          <div className="flex-1 space-y-6 max-w-2xl">
            ...
            <h1 className="font-display text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl lg:text-6xl leading-[1.1]">
              Frontend Developer building modern, performant, and <span className="text-accent">AI-powered</span> web applications.
            </h1>
            
            <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
              Hello, I'm Olabanji. I specialize in building responsive user interfaces, modular React codebases, and integrations with AI models.
            </p>
          ...
          <div className="relative flex justify-center items-center">
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-tr from-accent/20 to-transparent blur-2xl"></div>
            <div className="relative border border-border p-2 bg-card rounded-3xl shadow-xl max-w-[280px] sm:max-w-[320px]">
              <img
                src="/img/img-portfolio2.jpg"
                alt="Olabanji Peter Idowu"
                className="rounded-2xl object-cover aspect-[4/5] filter grayscale hover:grayscale-0 transition-all duration-300 shadow-inner"
                loading="eager"
              />
            </div>
          </div>
