...
export function FeaturedWork() {
  ...
  return (
    <section id="project-section" className="py-24 border-t border-border transition-colors duration-200">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-3 mb-16 text-center md:text-left">
          ...
          <p className="text-muted-foreground max-w-xl text-lg">
            Engineering case studies detailing core design, database architectures, and integrations.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="w-full lg:w-1/2 group">
                  <Link to={`/projects/${project.id}`} className="block overflow-hidden rounded-2xl border border-border bg-card p-2 shadow-sm hover:shadow-md transition-shadow">
                    <img 
                      src={project.image} 
